...
const Home = () => {
  const [products] = useState([
    { id: 1, image:"Images/rsv_bd.webp", name: "Mouse Gaming", price: 30000 },
    { id: 2, image:"Images/rsv_bd.webp", name: "Produk B", price: 50000 },
    { id: 3, image:"Images/rsv_bd.webp", name: "Produk c", price: 50000 },
    { id: 4, image:"Images/rsv_bd.webp", name: "Produk d", price: 50000 },
    { id: 5, image:"Images/rsv_bg.webp", name: "Produk e", price: 50000 },
    { id: 6, image:"Images/rsv_bg.webp", name: "Produk f", price: 50000 },
    { id: 7, image:"Images/rsv_bg.webp", name: "Produk g", price: 50000 },
    { id: 8, image:"Images/rsv_bg.webp", name: "Produk h", price: 50000 },
    { id: 9, image:"Images/rsv_w.webp", name: "Produk i", price: 50000 },
    { id: 10, image:"Images/rsv_w.webp", name: "Produk j", price: 50000 },
    { id: 11, image:"Images/rsv_w.webp", name: "Produk k", price: 50000 },
    { id: 12, image:"Images/rsv_w.webp", name: "Produk l", price: 50000 },
    // Tambahkan produk lainnya
  ]);

  // axios.get('http://127.0.0.1:6543/api/v1/produk',{
  //   headers: {
        ...
        <div className="left w-[70%] h-full ">
          <div className="head mb-[20px]">
            ...
            <div className="text-[16px]">
              Temukan helm yang cocok untuk keperluan dan kegantengan mu
            </div>
          </div>
            ...
            {products.map((product) => (
              ...
              >
                ...
                <div className="teks">
                  ...
                  <div className="price text-[11px] font-semibold text-orange-600">
                    {product.price}
                  </div>
                </div>
                <div className="btn flex justify-end mt-2">
                  <button
                    className="btn text-[11px] text-white bg-orange-600 rounded p-2 hover:bg-orange-900"
        ...
        <div className="right w-[30%] px-3 flex items-center justify-center ">
          <div className="keranjang produk bg-white h-[95%] w-full rounded-lg p-2 py-3 flex flex-col justify-between shadow-lg">
                ...
                >
                  ...
                  <div className="right flex gap-3 w-[160px]  justify-between ">
                    <div className="counter flex gap-2 items-center w-[70px] justify-between h-full">
                      <button
                        className="p-1 rounded-sm px-2 bg-orange-600 inline-block text-white"
            ...
            <div className="bottom ">
              ...
              <button className="bg-orange-600 hover:bg-orange-900 text-white w-full p-2">Checkout</button>
            </div>
          </div>
        </div>
      </div>
